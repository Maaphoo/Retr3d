...
#		shape = App.ActiveDocument.ActiveObject.Shape
		...
		#Color Part
		#.ActiveDocument.getObject(self.name+"Bottom").ShapeColor = (gv.printedR,gv.printedG,gv.printedB,gv.printedA)
		#.ActiveDocument.getObject(self.name+"ClampBottom").ShapeColor = (gv.printedR,gv.printedG,gv.printedB,gv.printedA)
		...
		#Color Parts
		#.ActiveDocument.getObject(self.name+"Top").ShapeColor = (gv.printedR,gv.printedG,gv.printedB,gv.printedA)
		#.ActiveDocument.getObject(self.name+"ClampTop").ShapeColor = (gv.printedR,gv.printedG,gv.printedB,gv.printedA)
...
#		#.activeDocument().resetEdit()
		...
		#.activeDocument().hide("Mirrored001")
