...
#		#.ActiveDocument.Pad.ShapeColor=#.ActiveDocument.Revolution.ShapeColor
#		#.ActiveDocument.Pad.LineColor=#.ActiveDocument.Revolution.LineColor
#		#.ActiveDocument.Pad.PointColor=#.ActiveDocument.Revolution.PointColor
		App.ActiveDocument.recompute()
#		#.activeDocument().resetEdit()
...
#		#.ActiveDocument.Pad.hide()
		#.ActiveDocument.Pad.Visibility = False
#		#.ActiveDocument.ActiveObject.ShapeColor=#.ActiveDocument.Pad.ShapeColor
#		#.ActiveDocument.ActiveObject.LineColor=#.ActiveDocument.Pad.LineColor
#		#.ActiveDocument.ActiveObject.PointColor=#.ActiveDocument.Pad.PointColor
		App.ActiveDocument.recompute()
...
#		#.ActiveDocument.Pocket.ShapeColor=#.ActiveDocument.Pad001.ShapeColor
#		#.ActiveDocument.Pocket.LineColor=#.ActiveDocument.Pad001.LineColor
#		#.ActiveDocument.Pocket.PointColor=#.ActiveDocument.Pad001.PointColor
